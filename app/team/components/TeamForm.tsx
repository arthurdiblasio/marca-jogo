...
export default function TeamForm({ mode = 'create', teamId = undefined }: TeamFormProps) {
  ...
  const {
    ...
    logoPreviewUrl, addLogoFile, fieldImagesHook, teamImagesHook,
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 mb-12 justify-center">
      <div className="bg-white p-4 rounded-lg shadow-lg w-full max-w-8xl m-2">
        ...
        <PageSubTitle>
          {mode === 'create' ? 'Preencha as informações do seu time.' : 'Atualize as informações do seu time.'}
        </PageSubTitle>
